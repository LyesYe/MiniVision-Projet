...
%token <entier>  token_ParOuvrante token_ParFermante token_CrochOuvrante token_CrochFermante
%token <entier>  token_virgule token_gui1 token_gui2 token_Deux_Points token_test_equal token_point
%token <entier>  token_Tabulation
%token <entier>  token_From token_Pil token_Image token_Def token_import token_as token_matplotlib token_numpy token_cv2
%token <entier>  token_load token_resize token_save token_show token_close token_Open token_Size token_convert token_new token_png
%token <entier>  token_for token_in_range token_return
%token <entier>  token_if token_else
%token <entier>  token_comment
%token <entier>  token_CST_REAL
...
Function_instruction : 
                token_Def token_idf token_ParOuvrante Params token_ParFermante token_Deux_Points Main ReturnInst { printf("*****************************************************************************exists %s",$2)}
                ;
...
Loop_instruction : 
                ...
                |token_for token_idf token_in_range token_ParOuvrante Expression token_ParFermante token_Deux_Points Main 
                ;
